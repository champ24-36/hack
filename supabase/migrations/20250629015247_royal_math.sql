/*
  # Complete Legal Platform Database Setup

  1. Database Schema
    - Creates all necessary tables for the legal platform
...
INSERT INTO legal_categories (name, description, icon) VALUES
  ('Employment Law', 'Workplace rights, discrimination, contracts', 'briefcase'),
  ...
  ('Personal Injury', 'Accidents, medical malpractice, compensation', 'shield'),
  ('Criminal Defense', 'Criminal charges, legal representation', 'shield-alert'),
  ('Immigration', 'Visas, citizenship, deportation defense', 'globe'),
  ('Contract Law', 'Document review and contract disputes', 'file-text'),
  ('Other Legal Matters', 'General legal questions and advice', 'help-circle')
